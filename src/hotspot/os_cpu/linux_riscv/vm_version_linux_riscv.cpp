...
void VM_Version::os_aux_features() {
  ...
  for (int i = 0; _feature_list[i] != NULL; i++) {
...
void VM_Version::vendor_features() {
  ...
  static const int RIVOS_MVENDORID = 0x6cf; // JEDEC: 0x4f, Bank: 14
